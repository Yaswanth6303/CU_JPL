...
class OldBookShelfTest {
    ...
    void testAddBook() {
        ...
        Book retrievedBook = this.oldShelfOne.getBook(b.getBookName());
        assertNotNull(retrievedBook);
        assertEquals(b.getBookName(), retrievedBook.getBookName());
    ...
    void testGetBook_Found() {
        ...
        assertNotNull(b);
        assertEquals("Core Java", b.getBookName());
    }
    ...
    void testGetBooks_DuplicateEntries() {
        ...
        assertNotNull(books);
        assertEquals(2, books.length);
        assertEquals("Java", books[0].getBookName());
        assertEquals("Java", books[1].getBookName());
    }
}
