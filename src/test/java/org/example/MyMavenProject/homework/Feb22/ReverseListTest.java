...
import org.example.MyMavenProject.homework.Feb22.ReverseList;
...
class ReverseListTest {
    ...
    void testReverseList_NormalCase() {
        ...
        assertEquals(expected, ReverseList.reverseList(input), "Reversing [1, 2, 3, 4, 5] should return [5, 4, 3, 2, 1]");
    }
    ...
    void testReverseList_EmptyList() {
        ...
        assertEquals(expected, ReverseList.reverseList(input), "Reversing an empty list should return an empty list");
    }
    ...
    void testReverseList_SingleElement() {
        ...
        assertEquals(expected, ReverseList.reverseList(input), "Reversing a single-element list should return the same list");
    }
    ...
    void testReverseList_Duplicates() {
        ...
        assertEquals(expected, ReverseList.reverseList(input), "Reversing [3, 3, 2, 1, 1] should return [1, 1, 2, 3, 3]");
    }
    ...
    void testReverseList_MixedNumbers() {
        ...
        assertEquals(expected, ReverseList.reverseList(input), "Reversing [-10, 0, 10, -20, 20] should return [20, -20, 10, 0, -10]");
    }
}
